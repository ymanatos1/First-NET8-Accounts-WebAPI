...
public class AccountTest
{
    ...
    public async Task Add_TestAsync(string name, string description, bool isActive)
    {
        //Arrange
    ...
    public async Task Add_IncompleteModelState_TestAsync()
    {
        ...
        //Act
        var ex = await Assert.ThrowsAsync<ModelStateInvalidException<Account>>(async () =>
        {
            var entriesWritten = await _service.Add(modelState.IsValid, account);
        });
    ...
    public async Task Update_TestAsync(int id, string name, string description, bool isActive)
    {
        //Arrange
        var account = new Account
        {
    ...
    [InlineData("Test Name 1", "Test Description 1", true)]
    [InlineData("Test Name 2", "Test Description 2", false)]
    public async Task Update_BadIdDiff_TestAsync(string name, string description, bool isActive)
    {
        //Arrange
        var account = new Account
        {
    ...
    private void assertGetAccountsEmptyOrSingleAdmin(IEnumerable<Account> accounts, int expectedAcounts)
    {
